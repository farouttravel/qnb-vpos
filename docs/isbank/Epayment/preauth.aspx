...
<script language="VB" runat="server">
    Sub Page_Load(Sender As Object, E As EventArgs)
        ...
        mycc5pay.host = "https://testvpos.asseco-see.com.tr/fim/api"
        mycc5pay.name = "imeceapi"
        mycc5pay.password = "OMAR1514"
        mycc5pay.clientid = "700657110524"
        mycc5pay.orderresult = "0"
        mycc5pay.oid = ""
        mycc5pay.cardnumber = "5892837420377165"
        mycc5pay.expmonth = "09"
        mycc5pay.expyear = "23"
        mycc5pay.chargetype = "Auth"
        'mycc5pay.putExtra("IMECECARDQUERY", "IMECECARDQUERY")
        mycc5pay.currency = 949
        mycc5pay.subtotal = 9.95

        'mycc5pay.putExtra("FDONEM","02")
        'mycc5pay.putExtra("IMCKOD", "04")
