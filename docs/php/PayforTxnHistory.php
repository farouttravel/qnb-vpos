<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
 <html>
     <head>
         <title>PayFor - İşlem Raporu</title>
     ...
     <?php
         ...
         $data = "".
          ...
          "TxnType=TxnHistory&".                                                                    //Islem Tipi
          "ReqDate=".$_POST["ReqDate"]."&".                                                         //Tarih(YYYYMMDD)
          "RequestStartDatetime=".$_POST["RequestStartDatetime"]."&".                               //Epoch Değeri(1605868025641)
    ...
    ?>
         ...
         <table class="table">
             ...
             <tr>
                 <td style="text-align: right">
                     Epoch Değeri(1605868025641) :
                 </td>
                 <td style="text-align: left">
                     <input type="text" name="RequestStartDatetime" maxlength="CloumnLength_RequestStartDatetime"    class="inputClass" value="" />
             </tr>
